...
def get_gemini_response(input,pdf_content,prompt):
    ...
    #prompt tells what the model needs to be doing
...
#text area so that it can take huge JD
...
input_prompt1 = """
 ...
 Full Stack Web development, Big Data Engineering, DEVOPS, Data Analyst,your task is to review the provided resume against the job description. 
